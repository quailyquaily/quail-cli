...
func GetPostContentTool(cl *client.Client) (mcp.Tool, mcps.ToolHandlerFunc, error) {
	tool := mcp.NewTool("get_post_content",
		mcp.WithDescription(`Return the post of a given channel and post slug. The tool will return both content and paid content if the user is logged in and paid for the post.
